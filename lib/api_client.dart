...
class ApiClient {
  ...
  ApiClient({this.basePath = "https://demo.erpnext.com"}) {
    // Setup authentications (key: authentication name, value: authentication).
    _authentications['basicAuth'] = HttpBasicAuth();
    _authentications['oAuth2'] = OAuth();
    _authentications['tokenAuth'] = ApiKeyAuth("header", "Authorization");
  }
  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'ApiresourceTimesheetTimeLogs':
          return ApiresourceTimesheetTimeLogs.fromJson(value);
        case 'ApiresourceWebhookWebhookData':
          return ApiresourceWebhookWebhookData.fromJson(value);
        case 'ApiresourceWebhookWebhookHeaders':
          return ApiresourceWebhookWebhookHeaders.fromJson(value);
        case 'Body':
          return Body.fromJson(value);
        case 'Body1':
          return Body1.fromJson(value);
        case 'Body2':
          return Body2.fromJson(value);
        case 'Body3':
          return Body3.fromJson(value);
        case 'Body4':
          return Body4.fromJson(value);
        case 'Body5':
          return Body5.fromJson(value);
        case 'DocList':
          return DocList.fromJson(value);
        case 'DocListData':
          return DocListData.fromJson(value);
        case 'DocType':
